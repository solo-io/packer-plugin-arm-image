...
//go:embed test_fixtures/template.pkr.hcl
var testBuilderHCL2Basic string

// Run with: PACKER_ACC=1 go test -count 1 -v ./pkg/builder/builder_acc_test.go  -timeout=120m
func TestAccScaffoldingBuilder(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "image-arm-builder_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
